package com.samwit.Connect4Game;
...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Samwit Adhikary");
        alert.setContentText("Hi! I am Samwit Adhikary, a final year student, focused on making" +
                " great web/app experience. Designing and Coding have been my passion since" +
                " the days I started working with computers but I found myself into app" +
                " development since 2019. I enjoy creating beautifully designed," +
                " intuitive and functional applications and websites. Being a BCA student" +
                " I believe in using science to find creative and practical solutions.");
        alert.show();
    }
